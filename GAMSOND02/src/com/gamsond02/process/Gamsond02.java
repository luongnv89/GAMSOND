...
//		long timeSum = 0;
		...
		for (int noData = 0; noData < dataInput.listFiles().length; noData++) {
			...
			System.out.println("Doc du lieu dau vao....");
			readData(url);
...
//				long timeAll = 0;
				...
				System.out.println("Khoi tao cac connection....");
				...
				System.out
						.println("Bat dau thuc hien sinh cac ca the moi ....");
				...
				long timeAll = (long) ((long) timeSum / (1000.0 * Config.NOGENERATION));
				// Tinh gia tri trung binh
				double fitnessAll = (double) ((double) fitnessSum / (1.0 * Config.NOGENERATION));
				try {
					// Create a new file output stream
					// connected to "myfile.txt"
